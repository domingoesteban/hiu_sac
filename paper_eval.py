...
log_dict = {}
log_dict['Compound Task'] = {}
log_dict['Compound Task']['SAC'] = {
    'algo': 'sac',
    'subtask': -1,
    'seeds': seeds,
    'last_idx': -1,
...
# log_dict['Compound Task']['HIUSAC-1'] = {
#     'algo': 'hiusac',
#     'subtask': -1,
#     'seeds': seeds,
#     'last_idx': -1,
#     'color': None,
# }
log_dict['Compound Task']['HIUSAC-2'] = {
    'algo': 'hiusac-p',
    'subtask': -1,
    'seeds': seeds,
    'last_idx': last_idx,
...
# log_dict['Compound Task']['HIUSAC-2-2'] = {
#     'algo': 'hiusac-p',
#     'subtask': -1,
#     'seeds': seeds,
#     'last_idx': -1,
...
log_dict['Composable Task 1'] = {}
# log_dict['Composable Task 1']['SAC'] = {
#     'algo': 'sac',
#     'subtask': 0,
#     'seeds': seeds,
#     'last_idx': -1,
#     'color': None,
# }
# log_dict['Composable Task 1']['HIUSAC-1'] = {
#     'algo': 'hiusac',
#     'subtask': 0,
#     'seeds': seeds,
#     'last_idx': -1,
#     'color': None,
# }
log_dict['Composable Task 1']['HIUSAC-2'] = {
    'algo': 'hiusac-p',
    'subtask': 0,
    'seeds': seeds,
    'last_idx': last_idx,
...
# log_dict['Composable Task 1']['HIUSAC-2-2'] = {
#     'algo': 'hiusac-p',
#     'subtask': 0,
#     'seeds': seeds,
#     'last_idx': -1,
...
log_dict['Composable Task 2'] = {}
# log_dict['Composable Task 2']['SAC'] = {
#     'algo': 'sac',
#     'subtask': 1,
#     'seeds': seeds,
#     'last_idx': -1,
#     'color': None,
# }
# log_dict['Composable Task 2']['HIUSAC-1'] = {
#     'algo': 'hiusac',
#     'subtask': 1,
#     'seeds': seeds,
#     'last_idx': -1,
#     'color': None,
# }
log_dict['Composable Task 2']['HIUSAC-2'] = {
    'algo': 'hiusac-p',
    'subtask': 1,
    'seeds': seeds,
    'last_idx': last_idx,
...
# log_dict['Composable Task 2']['HIUSAC-2-2'] = {
#     'algo': 'hiusac-p',
#     'subtask': 1,
#     'seeds': seeds,
#     'last_idx': -1,
